...
void OnAboutPW(GtkWidget* widget, gpointer data);
void OnAboutStega(GtkWidget* widget, gpointer data);
...
//void OnPuzzle(GtkWidget* widget, gpointer data);
void OnStega(GtkWidget* widget, gpointer data);
